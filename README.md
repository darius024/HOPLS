...
📖 **[Complete Guide](./HOPLS_COMPLETE_GUIDE.md)** - Comprehensive theory, mathematics, and implementation plan
...
See the [Complete Guide](./HOPLS_COMPLETE_GUIDE.md) for detailed theory, tensor mathematics, and step-by-step implementation plan.
